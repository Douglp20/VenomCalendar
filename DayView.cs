...
#pragma warning disable CS0414 // The field 'DayView.horizontalAppointmentHeight' is assigned but its value is never used
        private int horizontalAppointmentHeight = 20;
#pragma warning restore CS0414 // The field 'DayView.horizontalAppointmentHeight' is assigned but its value is never used
        ...
        private string m_AppointmentValue;
        public string AppointmentValue
        {
            get
            {
                return m_AppointmentValue;
            }
            set
            {
                m_AppointmentValue = value;
            }
        }
